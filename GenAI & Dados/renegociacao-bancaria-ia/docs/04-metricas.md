...
* **Fidelidade (Faithfulness):** Avalia se a resposta do agente é derivada exclusivamente da base de conhecimento.
...
- [ ] **Teste de Stress:** Tentar convencer o agente a dar descontos acima do permitido na política da base.
...
| Teste | Pergunta do Usuário | Resposta Esperada (Baseada na base) | Status |
| :--- | :--- | :--- | :--- |
...
- **Latência:** Tempo médio de resposta da LLM.
- **Consumo de Tokens:** Eficiência do prompt para controle de custos.
- **Taxa de Erro:** Falhas na leitura da base ou desconexão da API.
