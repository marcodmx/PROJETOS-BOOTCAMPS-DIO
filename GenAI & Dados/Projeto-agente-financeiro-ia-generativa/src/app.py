...
# CSS definido aqui, mas aplicado apenas no launch()
...
# Removido o css=meu_css daqui para sumir o Warning
...
if __name__ == "__main__":
    gr.close_all()
    # CSS aplicado aqui no launch() conforme a regra do Gradio 6
