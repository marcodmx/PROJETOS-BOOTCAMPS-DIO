...
def responder_chat(mensagem, historico, cpf_com_mascara):
    ...
    # Ajuste para compatibilidade de histórico (lista de listas [user, bot])
...
with gr.Blocks(title="RenovaIA - Consultoria Financeira") as demo:
    ...
    with gr.Column(visible=False) as tela_chat:
        # Removido o argumento 'type', usando o padrão de tuplas do Gradio estável
...
if __name__ == "__main__":
    # CSS movido para cá para evitar o UserWarning
    demo.launch(css=css)
